...
function Header() {
  return (
    ...
    <div className='header_nav'>
        ...
        <div className='header_option'>
            <span className='header_optionLineOne'>Requests</span>
